  ...
  return `
    <script>
      ...
      var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
        ...
        tooltipTriggerEl.addEventListener("focusin", (event) => {
          if (!tooltip._isShown()) {
            tooltip.show()
          }
        }, false);
        tooltipTriggerEl.addEventListener("focusout", (event) => {
          if (tooltip._isShown()) {
            tooltip.hide()
          }
        }, false);
          ...
          tooltip._setTimeout(() => {
            if (tooltip._isHovered) {
              ...
              tooltip.tip.addEventListener("mouseleave", (event) => {
                var tooltip = bootstrap.Tooltip.getInstance(document.querySelector('[aria-describedby="'+ event.target.id + '"]'));
                tooltip.hide();
              })
            }
      ...
      var _setTimeout = function(handler, timeout) {
