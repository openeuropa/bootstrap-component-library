(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.oec = factory(global.Popper));
  ...
  class Collapse extends BaseComponent {
    constructor(element, config) {
      ...
      this._config = this._getConfig(config);
      this._triggerArray = SelectorEngine.find(`${SELECTOR_DATA_TOGGLE$3}[href="#${element.id}"],` + `${SELECTOR_DATA_TOGGLE$3}[data-bs-target="#${element.id}"]`);
  ...
  class Modal extends BaseComponent {
    ...
    _showBackdrop(callback) {
      const animate = this._element.classList.contains(CLASS_NAME_FADE$4) ? CLASS_NAME_FADE$4 : '';
