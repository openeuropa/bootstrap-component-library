(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.oec = factory());
   ...
   * ------------------------------------------------------------------------
   */
  EventHandler.on(document, EVENT_CLICK_DATA_API$6, SELECTOR_DISMISS, Alert.handleDismiss(new Alert()));
  ...
  defineJQueryPlugin(NAME$a, Alert);
  ...
  class Button extends BaseComponent {
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        let data = Data.getData(this, DATA_KEY$9);
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$5, SELECTOR_DATA_TOGGLE$4, event => {
    event.preventDefault();

    const button = event.target.closest(SELECTOR_DATA_TOGGLE$4);

    let data = Data.getData(button, DATA_KEY$9);
    if (!data) {
  ...
  defineJQueryPlugin(NAME$9, Button);
  ...
  class Carousel extends BaseComponent {
    ...
    static carouselInterface(element, config) {
      let data = Data.getData(element, DATA_KEY$8);
      let _config = {
        ...Default$7,
    ...
    static dataApiClickHandler(event) {
      ...
      if (slideIndex) {
        Data.getData(target, DATA_KEY$8).to(slideIndex);
      }
  ...
  EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => {
    ...
    for (let i = 0, len = carousels.length; i < len; i++) {
      Carousel.carouselInterface(carousels[i], Data.getData(carousels[i], DATA_KEY$8));
    }
  });
  ...
  defineJQueryPlugin(NAME$8, Carousel);
  ...
  class Collapse extends BaseComponent {
    constructor(element, config) {
      ...
      this._triggerArray = SelectorEngine.find(
        `${SELECTOR_DATA_TOGGLE$3}[href="#${element.id}"],` +
        `${SELECTOR_DATA_TOGGLE$3}[data-bs-target="#${element.id}"]`
      );
    ...
    show() {
      if (this._isTransitioning || this._element.classList.contains(CLASS_NAME_SHOW$6)) {
        return
      }
      ...
      if (actives) {
        ...
        activesData = tempActiveData ? Data.getData(tempActiveData, DATA_KEY$7) : null;
      ...
      if (actives) {
        actives.forEach(elemActive => {
          ...
          if (!activesData) {
            Data.setData(elemActive, DATA_KEY$7, null);
          }
        });
      }
    ...
    hide() {
      ...
      if (triggerArrayLength > 0) {
        for (let i = 0; i < triggerArrayLength; i++) {
          ...
          if (elem && !elem.classList.contains(CLASS_NAME_SHOW$6)) {
    ...
    _addAriaAndCollapsedClass(element, triggerArray) {
      ...
      const isOpen = element.classList.contains(CLASS_NAME_SHOW$6);
    ...
    static collapseInterface(element, config) {
      let data = Data.getData(element, DATA_KEY$7);
      const _config = {
        ...Default$6,
        ...Manipulator.getDataAttributes(element),
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$3, SELECTOR_DATA_TOGGLE$3, function (event) {
    ...
    selectorElements.forEach(element => {
      const data = Data.getData(element, DATA_KEY$7);
      let config;
      if (data) {
  ...
  defineJQueryPlugin(NAME$7, Collapse);
  ...
  */
  ...
  class Dropdown extends BaseComponent {
    ...
    toggle() {
      ...
      const isActive = this._element.classList.contains(CLASS_NAME_SHOW$5);
    ...
    show() {
      if (this._element.disabled || this._element.classList.contains(CLASS_NAME_DISABLED$1) || this._menu.classList.contains(CLASS_NAME_SHOW$5)) {
        return
      }
      ...
      this._menu.classList.toggle(CLASS_NAME_SHOW$5);
      this._element.classList.toggle(CLASS_NAME_SHOW$5);
    ...
    static dropdownInterface(element, config) {
      let data = Data.getData(element, DATA_KEY$6);
    ...
    static clearMenus(event) {
      ...
      for (let i = 0, len = toggles.length; i < len; i++) {
        const context = Data.getData(toggles[i], DATA_KEY$6);
        const relatedTarget = {
        ...
        if (!toggles[i].classList.contains(CLASS_NAME_SHOW$5)) {
          continue
        }
        ...
        const hideEvent = EventHandler.trigger(toggles[i], EVENT_HIDE$3, relatedTarget);
        if (hideEvent.defaultPrevented) {
          continue
        }
        ...
        dropdownMenu.classList.remove(CLASS_NAME_SHOW$5);
        toggles[i].classList.remove(CLASS_NAME_SHOW$5);
        Manipulator.removeDataAttribute(dropdownMenu, 'popper');
        EventHandler.trigger(toggles[i], EVENT_HIDDEN$3, relatedTarget);
      }
    }
    ...
    static dataApiKeydownHandler(event) {
      ...
      if (/input|textarea/i.test(event.target.tagName) ?
        event.key === SPACE_KEY || (event.key !== ESCAPE_KEY$1 &&
      ...
      const isActive = this.classList.contains(CLASS_NAME_SHOW$5);
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_FORM_CHILD, e => e.stopPropagation());
  ...
  defineJQueryPlugin(NAME$6, Dropdown);
  ...
  class Modal extends BaseComponent {
    ...
    show(relatedTarget) {
      ...
      EventHandler.on(this._element, EVENT_CLICK_DISMISS$1, SELECTOR_DATA_DISMISS$1, event => this.hide(event));
    ...
    hide(event) {
      ...
      this._isShown = false;
      const transition = this._element.classList.contains(CLASS_NAME_FADE$4);
    ...
    dispose() {
      [window, this._element, this._dialog]
        .forEach(htmlElement => EventHandler.off(htmlElement, EVENT_KEY$5));
    ...
    _showBackdrop(callback) {
      const animate = this._element.classList.contains(CLASS_NAME_FADE$4) ?
        CLASS_NAME_FADE$4 :
        '';
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        this._backdrop.classList.add(CLASS_NAME_SHOW$4);
        ...
        this._backdrop.classList.remove(CLASS_NAME_SHOW$4);
  ...
  class Tooltip extends BaseComponent {
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        let data = Data.getData(this, DATA_KEY$4);
  ...
  class Popover extends Tooltip {
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        let data = Data.getData(this, DATA_KEY$3);
        const _config = typeof config === 'object' ? config : null;
        ...
        if (!data) {
          ...
          Data.setData(this, DATA_KEY$3, data);
        }
  ...
  class ScrollSpy extends BaseComponent {
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        let data = Data.getData(this, DATA_KEY$2);
        const _config = typeof config === 'object' && config;
  ...
  class Tab extends BaseComponent {
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        const data = Data.getData(this, DATA_KEY$1) || new Tab(this);
...
//# sourceMappingURL=oec.bundle.js.map
